...
> Maintained by GitHub Copilot to preserve technical context, session continuity, troubleshooting notes, and onboarding information for all contributors.
> For project overview and setup, see `README.md`.

---

## Table of Contents
- [Development Environment Highlights](#development-environment-highlights)
...
- [Session Continuity & Shared Context](#session-continuity--shared-context)
...
- YAML module/file descriptions are extracted to Markdown using `docs/extract_yaml_headers.py`.
- Doxygen config: `docs/Doxyfile`.
- All generated documentation is output to `docs/esphome/`, `docs/html/`, and `docs/latex/`.

**Commands:**
- All Docs: `make docs` (ESPHome + Doxygen)
- ESPHome Only: `make docs-esphome`
- Doxygen Only: `make docs-doxygen`
...
## Notes & Tips
- **Indent all shell code within Makefile recipes (for/while/if blocks) for readability, even if not required by shell.**
